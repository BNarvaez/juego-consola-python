...
def main():
    nombre_jugador = input(
        "¡Bienvenido a la aventura en el Esapacio! Por favor, ingrese tu nombre: "
    )
    ...
    while enemigos:
        ...
        while enemigo_actual.salud > 0:
            ...
            if accion == "atacar":
                ...
                if enemigo_actual.salud > 0:
                    dano_enemigo = enemigo_actual.atarcar()
                    print(
        ...
        if continuar != "s":
            print("Gracias por haber jugado Batalla Galáctica")
            break
